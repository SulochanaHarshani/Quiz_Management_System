...
public class QuizPage extends javax.swing.JFrame {
    ...
    public void submit()
    {
        String indexno=jLabel11.getText();
        answerCheck();
        try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            st.executeUpdate("update student set marks='"+marks+"' where indexno='"+indexno+"'");
            String marks1 = String.valueOf(marks);
            setVisible(false);
    ...
    public QuizPage() {
     ...
     Timer time;
     public QuizPage(String indexno) {
        initComponents();
        jLabel11.setText(indexno);
        ...
        try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select * from student where indexno='"+indexno+"'");
            while(rs.next())
            {
