...
public static int open=0;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/p5.PNG"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -150, 1390, 710));
        ...
        jMenu4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/delete q.png"))); // NOI18N
    ...
    private void jMenu7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu7MouseClicked
        ...
        JFrame jf=new JFrame();
        jf.setAlwaysOnTop(true);
        int a= JOptionPane.showConfirmDialog(jf,"Do you really want to Exit Aplication.","Select",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
              System.exit(0);
        }
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        ...
        else
        {
           JFrame jf=new JFrame();
            jf.setAlwaysOnTop(true); 
            JOptionPane.showConfirmDialog(jf,"One form is allready Open.");
        }
    ...
    private void jMenu3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu3MouseClicked
        ...
        if(open==0)
        {
            new AllQuection().setVisible(true);
            open=1;
        }
        else
        {
